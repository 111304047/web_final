  ...
  return (
    <div className="game-wrapper">
      ...
      {win && typeof window !== 'undefined' && ReactDOM.createPortal(
        <div className="game-overlay game-overlay-portal"><div className="game-dialog"><h2>Success！</h2><div className="button-group"><button onClick={handleAgainWin}>Again</button><button onClick={() => (window.location.href = "/")}>Back</button></div></div></div>,
        document.body
      )}
      {fail && typeof window !== 'undefined' && ReactDOM.createPortal(
        <div className="game-overlay game-overlay-portal"><div className="game-dialog"><h2>Fail！</h2><div className="button-group"><button onClick={handleAgainFail}>Again</button><button onClick={() => (window.location.href = "/")}>Back</button></div></div></div>,
        document.body
      )}
    </div>
  );
